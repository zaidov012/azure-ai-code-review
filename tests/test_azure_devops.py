...
class TestModels:
    ...
    def test_file_diff_from_api(self):
        ...
        api_data = {"changeType": "edit", "item": {"path": "/src/main.py"}}
    ...
    def test_file_diff_is_binary(self):
        ...
        binary_file = FileDiff(path="/images/logo.png", change_type=FileDiffOperation.ADD)

        text_file = FileDiff(path="/src/main.py", change_type=FileDiffOperation.EDIT)
...
class TestAzureDevOpsClient:
    ...
    def test_filter_reviewable_files_max_limit(self, mock_get_session, azdo_config):
        ...
        reviewable = client.filter_reviewable_files(file_changes, max_files=10)
