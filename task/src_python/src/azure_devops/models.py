...
class FileDiff:
    ...
    def from_api(cls, data: Dict[str, Any]) -> "FileDiff":
        ...
        change_type = change_type_map.get(change_type_str.lower(), FileDiffOperation.EDIT)
...
class ReviewComment:
    ...
    def to_thread_context(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "rightFileStart": {"line": self.line_number, "offset": 1},
            "rightFileEnd": {"line": self.line_number, "offset": 1},
        }
