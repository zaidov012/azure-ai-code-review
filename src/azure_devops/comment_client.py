    ...
    def create_comment_thread(
        ...
        payload = {
            ...
            "properties": {
                ...
                "severity": {
                    "$type": "System.String",
                    "$value": review_comment.severity
                },
                "category": {
                    "$type": "System.String",
                    "$value": review_comment.category
                }
            }
        }
        ...
        logger.debug(f"Comment severity: {review_comment.severity}, category: {review_comment.category}")
    ...
    def post_review_comments(
        ...
        for i, comment in enumerate(comments, 1):
            try:
                ...
                results["failed"] += 1
                error_msg = f"Failed to post comment at {comment.file_path}:{comment.line_number}: {str(e)}"
