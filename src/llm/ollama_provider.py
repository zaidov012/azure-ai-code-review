...
class OllamaProvider(LLMProvider):
    ...
    def __init__(self, config: LLMConfig):
        ...
        logger.info(
            f"Initialized Ollama provider " f"(model: {self.model}, endpoint: {self.api_base})"
        )
    ...
    def generate_completion(
        ...
        try:
            ...
            logger.error(
                f"Failed to connect to Ollama at {self.api_base}. " "Make sure Ollama is running."
            )
            raise
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.error(
                f"❌ Cannot connect to Ollama at {self.api_base}. " "Make sure Ollama is running."
            )
            return False
        except Exception as e:
