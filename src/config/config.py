...
class ReviewConfig:
    ...
    review_scope: List[str] = field(default_factory=lambda: [
        "code_quality",
        "security",
        "performance",
        "best_practices",
...
class Config:
    ...
    def validate(self) -> List[str]:
        ...
        if not self.azure_devops.pat_token:
            errors.append("Azure DevOps PAT token is required (set in config or AZDO_PERSONAL_ACCESS_TOKEN env var)")
